...
logging.info("Startup: Stripe key present=%s", bool(stripe.api_key))
...
def create_stripe_session():
    ...
    logging.info("pay-invoice request: amount=%s invoice_ref=%s stripe_key_present=%s",
                 amount_in_cents, invoice_ref, bool(stripe.api_key))
...
if __name__ == '__main__':
    ...
    logging.info("Starting Flask app on http://0.0.0.0:%s/", port)
